...
public static class D3D11SharedTextureFactory
{
        ...
        Format format = Format.B8G8R8A8_UNorm)
    {
        ...
        return CreateSharedTextureHandle(texture, keyedMutex, sharedHandle, width, height, format, GpuTextureId.New());
    }

    internal static D3D11SharedTextureFrameHandle CreateSharedTextureWithTextureId(
        ID3D11Device device,
        uint width,
        uint height,
        ...
        Format format = Format.B8G8R8A8_UNorm)
    {
        ...
        return CreateSharedTextureHandle(texture, keyedMutex, sharedHandle, width, height, format, textureId);
    }

    private static D3D11SharedTextureFrameHandle CreateSharedTextureHandle(
