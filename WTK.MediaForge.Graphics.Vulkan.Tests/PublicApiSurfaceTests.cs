    ...
    private static readonly IReadOnlyDictionary<string, string[]> ApprovedPublicTypes =
        new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            [
                ...
                "WTK.MediaForge.Composition.Runtime.Outputs.OffscreenRenderOutputTarget",
                "WTK.MediaForge.Composition.Runtime.Outputs.RenderOutputTarget",
                "WTK.MediaForge.Composition.Runtime.Outputs.WinFormsPreviewRenderOutputTarget",
