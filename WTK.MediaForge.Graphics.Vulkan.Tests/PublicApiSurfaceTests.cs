    ...
    private static readonly IReadOnlyDictionary<string, string[]> ApprovedPublicTypes =
        new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            [
                ...
                "WTK.MediaForge.Composition.Media.Mux.EncodedPacketMp4Muxer",
                "WTK.MediaForge.Composition.Media.Mux.IMp4Muxer",
                "WTK.MediaForge.Composition.Media.Stream.FlvPacket",
                "WTK.MediaForge.Composition.Media.Stream.FlvPacketizer",
                "WTK.MediaForge.Composition.Media.Stream.RtmpTransport",
                ...
                "WTK.MediaForge.Composition.Sources.StaticImageAssetLoader",
