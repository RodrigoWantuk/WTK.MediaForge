...
- `HardwareMediaProof` and `HardwareMediaProofStatus` report concrete v6 proof results for render-to-encode, hardware encode, MP4 recording, hardware decode, and decode-to-render. Non-passed proofs must include a user-visible reason.
